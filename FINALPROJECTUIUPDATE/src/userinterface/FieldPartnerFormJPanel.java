...
public class FieldPartnerFormJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtKivaReferencePerson = new javax.swing.JTextField();
        ...
        jLabel2.setText(" KIVA PARTNERSHIP APPLICATION ");
        ...
        txtKivaReferencePerson.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 4, true));
        jPanel1.add(txtKivaReferencePerson, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 810, 290, 30));
        ...
        jLabel20.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 6, true));
        jPanel1.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 20, -1, -1));
    ...
    private void btnFieldPartnerSignUpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFieldPartnerSignUpActionPerformed
        ...
        String refPerson = txtKivaReferencePerson.getText();
        ...
        GeneralDetails generalDetails = new GeneralDetails(orgName.trim(), website.trim(), address.trim(), countryOfOperation.trim(), 
        ...
        NewFieldPartnerWorkRequest fieldPartnerWorkRequest = new NewFieldPartnerWorkRequest(generalDetails, performanceDetails, fieldPartnerContact);
        fieldPartnerWorkRequest.setMessage("Application for a new Field Partner");
        for(Organization organization : enterprise.getOrganizationDirectory().getOrganizationList()){
            if(organization instanceof AnalystOrganization) analystOrganization = (AnalystOrganization)organization ;
        }
        
        fieldPartnerWorkRequest.pushToOrganizationWorkQueue(analystOrganization);
    ...
    private javax.swing.JTextField txtKivaReferencePerson;
