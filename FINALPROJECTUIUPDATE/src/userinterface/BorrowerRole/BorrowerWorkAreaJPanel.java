...
import userinterface.BorrowerRole.RepaymentJPanel ;
...
public class BorrowerWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(33, 427, 330, 50));

        creditComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        add(creditComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(42, 510, 182, -1));
        ...
        add(btnAddCredit, new org.netbeans.lib.awtextra.AbsoluteConstraints(242, 509, 94, 30));
        ...
        add(txtCurrentBalance, new org.netbeans.lib.awtextra.AbsoluteConstraints(33, 629, 320, 60));
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(33, 561, 320, 40));
    ...
    private void btnViewLoancaseStatusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewLoancaseStatusActionPerformed
        ...
        LoanCaseStatusJPanel loanCaseStatusJPanel = new LoanCaseStatusJPanel(userProcessContainer, (KivaEnterprise)business, borrower);
    ...
    private void btnRepaymentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRepaymentActionPerformed
        // TODO add your handling code here:
        RepaymentJPanel repaymentJPanel = new RepaymentJPanel(userProcessContainer, (KivaEnterprise)business, borrower);
